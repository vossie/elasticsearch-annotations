...
import org.vossie.elasticsearch.annotations.enums.ElasticsearchAnnotationTypeNames;
    ...
    public boolean process(Set<? extends TypeElement> typeElements,
        ...
        for (Element element : elements) {
            ...
            if(elasticsearchType.type().equals(FieldType.GEO_SHAPE)) {
                ...
                if(!("org.vossie.elasticsearch.types.ElasticsearchGeoShape".equals(element.asType().toString()))) {
